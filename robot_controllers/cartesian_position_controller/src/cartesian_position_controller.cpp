...
//     end_pos_cmd_.M = End_Pos_Rotation.Quaternion(x,y,z,w);
//     ik_pos_solver_->CartToJnt(this->joint_state_.q, end_pos_cmd_, Jnt_Pos_Cmd_);
//     ros::Duration dt(1/125);
//     writePositionCommands(dt);
//     dt.sleep();
//     End_Pos_.p[0] = end_pos_vector[0];
//     End_Pos_.p[1] = end_pos_vector[1];
//     End_Pos_.p[2] = end_pos_vector[2];
//     std::cout<<End_Pos_.p[0]<<";"<<End_Pos_.p[1]<<";"<<End_Pos_.p[2]<<std::endl;
//   // }while(true);
//     std::cout<< fabs(End_Pos_Cmd_.p[0] - End_Pos_.p[0]) <<","<<fabs(End_Pos_Cmd_.p[1] - End_Pos_.p[1])<<","<<fabs(End_Pos_Cmd_.p[2] - End_Pos_.p[2])<<std::endl;
//   }while(fabs(End_Pos_Cmd_.p[0] - End_Pos_.p[0])>0.01 || fabs(End_Pos_Cmd_.p[1] - End_Pos_.p[1])>0.01 || fabs(End_Pos_Cmd_.p[2] - End_Pos_.p[2])>0.01);
