...
void Admittance::state_wrench_callback(
  ...
  if (ft_arm_ready_) {
    wrench_ft_frame <<  msg->force.x,msg->force.y,msg->force.z,0,0,0;
    ...
    //                     msg->wrench.torque.y,
    //                     msg->wrench.torque.x;
    float force_thres_lower_limit_ = 0;
    float force_thres_upper_limit_ = 10;
...
void Admittance::send_commands_to_robot() {
  ...
  arm_twist_cmd.linear.x  = arm_desired_twist_adm_(0)*0.5;
  arm_twist_cmd.linear.y  = arm_desired_twist_adm_(1)*0.5;
  arm_twist_cmd.linear.z  = arm_desired_twist_adm_(2)*0.5;
  arm_twist_cmd.angular.x = arm_desired_twist_adm_(3)*0.5;
  arm_twist_cmd.angular.y = arm_desired_twist_adm_(4)*0.5;
  arm_twist_cmd.angular.z = arm_desired_twist_adm_(5)*0.5;
